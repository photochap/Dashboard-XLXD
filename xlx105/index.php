...
<head>
    ...
    <title>F4HWB - <?php echo $Reflector->GetReflectorName(); ?> Dashboard</title>
    ...
    <link href="css/f4hwb.css" rel="stylesheet">
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <span class="navbar-brand"><?php echo $Reflector->GetReflectorName(); ?> Multiprotocol Gateway - F4HWB - 73 de Christophe</span>
        </div>
...
<div class="container-fluid">
<div class="news">Bonjour quelques modifications sur le serveur m ont obliger � l arreter aujourd hui. <br> D�sol� pour le d�rangement<br>73 Christophe F4HWB
</div>
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
<li>
<div style="margin-left: auto;margin-right: auto;width: 108px;">
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="P3LQHYR2BUVBE">
...
<img alt="" border="0" src="https://www.paypalobjects.com/fr_FR/i/scr/pixel.gif" width="1" height="1">
                ...
                <li><a href="journal.html" target="_blanck">Journal du xrf105</a></li>
                <li<?php echo ($_GET['show'] == "modules") ? ' class="active"' : ''; ?>><a
                            href="./index.php?show=modules">Répartition des modules</a></li>
                <li><a href="http://f4hwb.fr" target="_blanck">F4HWB</a></li>
                <li><a href="http://d-star.fr" target="_blanck">Forum D-Star Francophone</a></li>
                <li><a href="http://photochap.fr" target="_blanck">Photochap</a></li>
                <li><a href="http://chappat.eu" target="_blanck">Hébergement de site web</a></li>
